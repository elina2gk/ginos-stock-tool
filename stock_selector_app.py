...
PAGES = ["Portfolio", "Discover", "Leaders", "Screener", "My Watchlist", "Alerts", "Earnings"]
...
picked = st.radio(
    "Page",
    PAGES,
    index=PAGES.index(st.session_state.page) if st.session_state.page in PAGES else 1,
    horizontal=True,
